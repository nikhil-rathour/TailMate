    ...
    <div className="bg-navy min-h-screen text-white">
      ...
      <section className="relative bg-navy h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center z-10 px-4">
          ...
          >
            Thousands of loving pets are waiting for their new home. Explore profiles from trusted shelters and individuals.
          </motion.p>
          <motion.div 
                  ...
                  <div className="p-6">
                    ...
                    {pet.listingType === "sale" && pet.price && (
                      <div className="mb-4 text-right">
                        <span className="text-xl font-bold text-gold">${pet.price}</span>
                      </div>
                    )}
                    <motion.button
                    ...
                    >
                      {pet.listingType === "adoption" ? "Adopt Me!" : "View Details"}
                    </motion.button>
                  </div>
                </motion.div>
              ))
